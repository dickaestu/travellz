                        ...
                        <tbody>
                          <tr>
                            <td style="width:180px;">
                              <img height="auto" src="{{url('frontend/images/logo_travellz@2x.png')}}"
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;"
                  ...
                  <tr>
                    <td align="center"
                      ...
                      <div
                        style="font-family:Playfair-Display, Times New Roman, Serif;font-size:30px;font-weight:bold;line-height:1;text-align:center;color:#DB593F;">
          ...
          <![endif]-->
              <div class="mj-column-per-100 mj-outlook-group-fix"
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                  <tbody>
                    <tr>
                      <td style="border-bottom:1px dashed #eee;vertical-align:top;padding-bottom:30px;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="" width="100%">
                          <tr>
                            <td align="left"
                              style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                              <div
                                style="font-family:Assistant, Helvetica, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#DB593F;">
                          ...
                          <tr>
                            <td align="left"
                              ...
                              <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                style="color:#DB593F;font-family:Assistant, Helvetica, sans-serif;font-size:18px;line-height:28px;table-layout:auto;width:100%;border:none;">
                                <tr>
                                ...
                                <tr>
                                  <td align="center" bgcolor="#FF9E53" role="presentation"
                                    ...
                                    <a href="{{url('checkout/'. $data->id)}}"
                                      style="display:inline-block;background:#FF9E53;color:#ffffff;font-family:Assistant, Helvetica, Arial;font-size:18px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;">
                                      Check Detail </a>
                                  </td>
                                </tr>
                              </table>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;"
                  ...
                  <tr>
                    <td align="left"
                      style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                      <div
                        style="font-family:Assistant, Helvetica, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#000000;">
                        Butuh Bantuan?</div>
                    </td>
                  </tr>
                </table>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0"
                        ...
                        <tr>
                          <td style="width:50px;"> <img src="{{url('frontend/images/ic_support@2x.png')}}" width="50px"></td>
                          <td
                            style="font-size:18px; padding-left:10px; color:#000; font-family:Assistant, Helvetica, Arial">
                            support@travellz.id <br> 021-2019-2022 </td>
                        </tr>
                      </table>
                    </td>
                  </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;"
                  ...
                  <tr>
                    <td align="center"
                      ...
                      <div
                        style="font-family:Assistant, Helvetica, Arial;font-size:18px;line-height:1;text-align:center;color:#888b93;">
                        2020 Travellz Copyright All Rights Reserved.</div>
                    </td>
                  </tr>
                </table>
              </div>
